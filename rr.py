...
def naive_next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER):
    ...
    xy_estimate = ekf(x, P, measurements)
...
u = matrix([[-10.], [-10.], [0.]])  # external motion
F = matrix([[1., 1., 0.], [0, 1., 1.], [0, 1., 1.]])  # next state function
H = matrix([[0., 1., 0.], [0., 0., 1.]])  # measurement function
R = matrix([[3., 0.], [0., 3.]])  # measurement uncertainty
